...
export const createAccountSchema = {
  body: z.object({
    ...
    password: z.string().trim().min(6, 'Mật khẩu phải có ít nhất 6 ký tự.').max(128, 'Mật khẩu quá dài.'),
...
export const updateAccountSchema = {
  ...
  body: z.object({
    ...
    password: z.string().trim().min(6, 'Mật khẩu phải có ít nhất 6 ký tự.').max(128, 'Mật khẩu quá dài.').optional(),
